...
class Account(models.Model):
    ...
    street_address = models.CharField(verbose_name=_('address'), max_length=100,
        help_text=_('example: 55 Linda Lane'), blank=True)
    city = models.CharField(verbose_name=_('city'), max_length=100,
        help_text=_('example: Allentown'), blank=True)
    state = models.CharField(verbose_name=_('state'), max_length=40,
        choices=STATE_CHOICES, default='PA')
    zip_code = models.CharField(verbose_name=_('zip code'), max_length=5)
